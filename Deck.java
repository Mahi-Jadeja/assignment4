// Deck.java - Defines the Deck class that manages a deck of cards.
...
public class Deck {
    ...
    // Constructor that initializes the deck with 52 cards
    public Deck() {
        deck = new ArrayList<>();
        createDeck();
    }
    ...
    public void createDeck() {
        ...
        deck.clear(); // Ensuring deck is empty before creation
